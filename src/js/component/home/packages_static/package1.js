...
function expandData1() {
    return (
        <div className="package_wrapper">
            ...
            <h6>Includes</h6>
            <ul>
                <li>3 night accommodation in Mysore,Ooty </li>
                <li>A/C Etios Vehicle from Bangalore,Mysore,Ooty  /Bangalore as per the itinerary</li>
                <li>A/C Etios vehicle for local sight seeing as per the Itinerary.</li>
                <li>All parking, toll included.</li>
                <li>Driver allowance included.</li>
                <li>Tamil nadu permit included</li>
            </ul>
        </div>
    );
}
export default expandData1;